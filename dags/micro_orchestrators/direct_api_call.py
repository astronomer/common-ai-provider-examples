...
calls the OpenAI SDK directly with a hand-written tool-calling loop and
structured output parsing. No agent framework at all: this is the floor the
other five DAGs should be compared against.
"""
...
@dag(
    ...
    schedule=None,
    catchup=False,
    tags=["micro-orchestrator", "openai-sdk", "example", "space", "support-ticket"],
    doc_md=__doc__,
)
