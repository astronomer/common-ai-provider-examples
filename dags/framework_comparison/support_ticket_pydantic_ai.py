...
The `support_ticket_common_ai` flow with pydantic-ai called directly inside a
plain `@task`. Agent
construction, model selection and output handling are all yours to write here.
`@task.agent` does those three.
"""
