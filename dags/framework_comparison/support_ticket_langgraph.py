...
The `support_ticket_common_ai` flow with a LangGraph ReAct agent
(`create_react_agent` plus `langchain-openai`) drafting the reply inside a
plain `@task`. LangGraph is the agent-orchestration library of the LangChain
family.
"""
